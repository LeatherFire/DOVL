// src/app/admin/kampanyalar/[id]/duzenle/page.js
"use client";
...
export default function AdminEditCampaign() {
  ...
  // Kampanya verilerini yükleme
  useEffect(() => {
    // Kategorileri ve ürünleri yükle (mock)
    setCategories([
    ...
    // Kampanya verilerini yükle (mock)
    const loadCampaign = () => {
      ...
      setTimeout(() => {
        ...
        if (id === 'camp001') {
          ...
          sampleCampaign = {
            ...
            selectedCategories: ['elbise', 'bluz', 'etek'],
            selectedProducts: [],
            isActive: true,
            usageCount: 0,
          ...
          sampleCampaign = {
            ...
            selectedCategories: [],
            selectedProducts: ['elbise-1', 'bluz-1', 'pantolon-1'],
            isActive: true,
            usageCount: 0,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Kampanya başarıyla güncellendi:', formData);
      setSuccess(true);
      ...
      setErrors({ submit: 'Kampanya güncellenirken bir hata oluştu. Lütfen tekrar deneyin.' });
    } finally {
  ...
  if (isLoading) {
    return (
      <div className="admin-loading">
        ...
        <p>Kampanya bilgileri yükleniyor...</p>
      </div>
    );
  }
  
  return (
    <div className="admin-edit-campaign">
      <div className="admin-page-header">
        <h1 className="admin-page-title">Kampanya Düzenle: {formData.name}</h1>
      ...
      {success && (
        <div className="admin-alert admin-alert-success">
          ...
          <span>Kampanya başarıyla güncellendi!</span>
        </div>
      )}
          ...
          <div className="admin-panel-content">
            ...
            {formData.usageCount > 0 && (
              <div className="admin-form-info">
                <p>Bu kampanya şu ana kadar <strong>{formData.usageCount}</strong> kez kullanılmıştır.</p>
              </div>
            )}
          </div>
        </div>
