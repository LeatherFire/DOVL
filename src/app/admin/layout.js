      ...
      <div className={`admin-sidebar ${isSidebarOpen ? 'open' : 'closed'}`}>
        ...
        <nav className="admin-navigation">
          <ul className="admin-menu">
            ...
            <li className="admin-menu-item">
              <Link href="/admin/kategoriler" className={`admin-menu-link ${pathname.startsWith('/admin/kategoriler') ? 'active' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="20" height="20">
            ...
            <li className="admin-menu-item">
              <Link href="/admin/kullanicilar" className={`admin-menu-link ${pathname.startsWith('/admin/kullanicilar') ? 'active' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="20" height="20">
            ...
            <li className="admin-menu-item">
              <Link href="/admin/ayarlar" className={`admin-menu-link ${pathname.startsWith('/admin/ayarlar') ? 'active' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="20" height="20">
